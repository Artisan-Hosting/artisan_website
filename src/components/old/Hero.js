        ...
        <>
            <div className="hero" id='hero'>
                ...
                <div className="m-auto overflow-hidden mx-4 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="mt-8 flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            <h1 className="mb-5 md:text-5xl text-3xl font-bold text-blue-900">
                            {/* We build digital solutions to help businesses scale */}
                                Reliable, high-performance hosting with personal support.                                
