        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        ...
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">How can Artisan Hosting empower you ?</h2>
                    </div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Engineering Consultation</h2>
                                    <p className="text-md font-medium">
                                        ...
                                        We welcome developers of all backgrounds and expertise levels. Need guidance on implementing a new feature or have questions about our hosting environment? Schedule a call with one of our experienced engineers for personalized support and guidance.
                                    </p>
                                </div>
                            </div>
                            ...
                            {/* Adding auditing services to my platform  */}
            ...
            <section>
                <div className="m-auto max-w-6xl p-3 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                ...
                                With our in house (soon to be opensource) software and expert in-house team, we deliver fast, reliable, and secure hosting that scales and adapts to the evolving needs of your project.                                    
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We can collaborate with your existing tech team to scale existing software applications and or simplify various processes of your current deployment.</p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4'>
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">We <span className='font-black'>Integrate</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>By leveraging GIThub/lab we can Integrate with your existing development flow to offer staging and production environments based on branches from your projects</p>
                            </div>
                        </div>
                    </div>
                </div>
